...
module.exports = {
    name: "messagelogger",
    usage: ["Set the message logger channel for the bot.```{prefix}logger set #channel```", "Disable the message logger for the bot.```{prefix}logger disable```"],
    enabled: true,
    hidden: false,
    aliases: ["msglogs", "msglogger"],
    category: "Logs",
