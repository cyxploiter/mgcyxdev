...
module.exports = {
    ...
    async execute(client, message, args, data) {
        try {
            let user = !args[0] ? "cyxploiter" : args[0];
            ...
            console.log(instagram.bio, instagram.image, instagram.followers, instagram.following, instagram.id, topImage.likes, topImage.comments, topImage.image);
